...
/* листинг 4.2.2 поиск в глубину. ƒостижимость в орграфах */
...
{
	//QString path{ _paths[0] }; // ƒл€ определени€ наличи€ цикла
	QString path{ _paths[1] }; // ”пор€дочение вершин
